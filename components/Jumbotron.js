      ...
      <div className="absolute flex flex-col w-full h-full items-center justify-center text-center">
        <div className="max-w-7xl inline-flex flex-col gap-7 mt-64">
          <motion.div
            ...
            animate="show"
            variants={container}
            className="flex gap-2 items-center text-gray-100 text-7xl font-bold"
          >
          ...
          <div className="flex gap-3 justify-center">
            <motion.button
              ...
              animate="show"
              variants={button1}
              className="rounded-full text-lg px-8 py-3 text-white border border-white"
            >
              About us
            </motion.button>
            <motion.button
              ...
              animate="show"
              variants={button2}
              className="text-green-600 text-lg bg-white rounded-full px-8 py-3"
            >
              Request an Estimate
            </motion.button>
          </div>
